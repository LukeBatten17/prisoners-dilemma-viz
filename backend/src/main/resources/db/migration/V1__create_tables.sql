...
CREATE TABLE IF NOT EXISTS rounds (
    ...
    strategy_one_move VARCHAR(20) NOT NULL CHECK (strategy_one_move IN ('COOPERATE', 'DEFECT')),
    strategy_two_move VARCHAR(20) NOT NULL CHECK (strategy_two_move IN ('COOPERATE', 'DEFECT')),
    strategy_one_points INT NOT NULL,
    strategy_two_points INT NOT NULL,
